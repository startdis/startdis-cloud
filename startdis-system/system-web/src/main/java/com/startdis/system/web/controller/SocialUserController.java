 ...
 * @desc 社交用户表(SocialUser)控制层
 */
@Validated
@RestController
@ApiSort(value = 1)
@Api(value = "SocialUser", tags = {"社交用户表"})
...
public class SocialUserController {
    ...
    public ResultBean<PagerBean<SocialUserVO>> page(PageQuery pageQuery, SocialUserQuery socialUserQuery) {
        ...
        PagerBean<SocialUserVO> pageBean = new PagerBean<>(pageResult.getTotal(), pageResult.getCurrent(),
                pageResult.getSize(), BeanCopyUtils.coverList(pageResult.getRecords(), SocialUserVO.class));
    ...
    public ResultBean<Boolean> delete(@RequestParam("ids") List<String> ids) {
        return ResultBean.success(socialUserService.removeByIds(ids));
    }
