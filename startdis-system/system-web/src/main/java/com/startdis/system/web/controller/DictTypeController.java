...
import com.startdis.system.domain.model.converter.DictTypeConverter;
...
public class DictTypeController {
    ...
    public ResultBean<DictTypeVO> get(@PathVariable @Validated @NotBlank(message = "ID不能为空") String id) {
        ...
        //处理格式转换
        DictTypeVO dictTypeVO = DictTypeConverter.INSTANT.entityToVO(dictType);
    ...
    public ResultBean<List<DictTypeVO>> list(DictTypeQuery dictTypeQuery) {
        //处理格式转换
        DictType dictType = DictTypeConverter.INSTANT.queryToEntity(dictTypeQuery);
        //执行分页查询
    ...
    public ResultBean<Boolean> insert(@RequestBody @Validated DictTypePostDTO dictTypeDTO) {
        //处理格式转换
        DictType dictType = DictTypeConverter.INSTANT.postDtoToEntity(dictTypeDTO);
        //执行数据保存
    ...
    public ResultBean<Boolean> update(@RequestBody @Validated DictTypePutDTO dictTypeDTO) {
        //处理格式转换
        DictType dictType = DictTypeConverter.INSTANT.putDtoToEntity(dictTypeDTO);
        //执行数据更新
