package com.startdis.common.minio.service;

import com.startdis.common.minio.domian.FileInfo;
import io.minio.*;
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*MinioClient minioClient =
                MinioClient.builder()
                        ...
                        .build();*/
        boolean found =
                minioClient.bucketExists(BucketExistsArgs.builder().bucket("dianjiu").build());
        if (found) {
